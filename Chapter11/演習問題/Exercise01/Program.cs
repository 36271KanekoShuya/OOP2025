...
namespace Exercise01 {
    internal class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine(IsPhoneNumber("080-9111-12341"));
            Console.WriteLine(IsPhoneNumber("A080-9111-1234"));
            Console.WriteLine(IsPhoneNumber("080-911-1234"));
            Console.WriteLine(IsPhoneNumber("080-9111-234"));
        }

        private static bool IsPhoneNumber(string telNum) {
            return Regex.IsMatch(telNum,@"^0[7-9]0(-\d{4}){2}$");
        }
    }
}
